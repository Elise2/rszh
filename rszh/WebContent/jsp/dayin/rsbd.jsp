...
<body>
	<form action="">
	<input type="text" name="tableName" value="personal">
	<input type="text" name="编号" value="" id="bianhao">
	<input type="submit" value="打印" class="btn btn-success" />
	</form>
	<div id="contentRight"
