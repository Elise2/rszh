...
<body>
	...
	<form class="form-inline definewidth m20" id="table_tool" action="/xinZengServlet"
		method="post">
		<input type="hidden" name="tableName" value="personal">
		<div id="contentRight" style="width: 100%;">
		<table cellpadding="5px" class="table table-bordered table-hover definewidth m10">
			<%
